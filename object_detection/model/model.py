...
class Model(nn.Module):
    ...
    def print_region_proposal_summary(self) -> None:
        ...
        for index_string, region_proposal_object in self.region_proposer_dictionary.items():
            ...
            # Calculate the total number of region proposal anchors generated by this specific block
            # by multiplying the spatial area of the feature map by the number of anchors spawned at each spatial location
